...
[[loop-engineering]] — 类似的系统化循环理念，Addy Osmani 的五原语框架
- [[skill-file]] — CE 的 35+ skills 是 skill file 的大规模实践
- [[skillify]] — 每次失败转化为永久修复
- [[thin-harness-fat-skills]] — 保持框架精简，智能封装在技能文件中
