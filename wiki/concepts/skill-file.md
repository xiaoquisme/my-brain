...
- [[compound-engineering]] — CE 的 14 skills 就是 skill file 的大规模实践
- [[loop-engineering]] — Skills 是循环的五个核心原语之一
- [[model-alignment]] — Agent 的 skill 文件是 alignment 后"持续学习"的主要方案
- [[human-3.0]] — 技能获取是 Human 3.0 框架中 Traits 横向发展的核心
